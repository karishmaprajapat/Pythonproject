...
small_botton = tk.Button(Size_frame, text="Small", command=set_small_pen)
small_botton.pack(side=tk.LEFT, padx=2)

medium_botton = tk.Button(Size_frame, text="Medium", command=set_medium_pen)
medium_botton.pack(side=tk.LEFT, padx=2)

large_botton = tk.Button(Size_frame, text="Large", command=set_large_pen)
large_botton.pack(side=tk.LEFT, padx=2)
